...
public class EaseContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer {
    ...
    public EaseContactAdapter(Context context, int resource, List<EaseUser> objects,List<GroupUserInfo> groupUserInfos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(userinfo!=null){
            ...
            String remark = user.getMyremark();
        ...
        EaseUserUtils.setUserAvatar(getContext(),  user.getMyhead(), holder.avatar);
