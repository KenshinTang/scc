...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	private int default_res = R.drawable.defalutuserhead;
	private String localFilePath;
	private Bitmap bitmap;
	private boolean isDownloaded;

	private  View image_toolbar;

	private TextView user_info_title;
	private RelativeLayout user_info_delete;
	private  RelativeLayout user_info_back;
	private ImageView jx_chat_and_mail_title_left_image;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		jx_chat_and_mail_title_left_image=(ImageView)findViewById(R.id.jx_chat_and_mail_title_left_image);

		user_info_title.setText("查看图片");
		...
		CommonUtils.setImageLayout(this,jx_chat_and_mail_title_left_image,20,20);
		image = (EasePhotoView) findViewById(R.id.image);
		ProgressBar loadLocalPb = (ProgressBar) findViewById(R.id.pb_load_local);
		default_res = getIntent().getIntExtra("default_image", R.drawable.defalutuserhead);
		...
		if(!TextUtils.isEmpty(headUrl)){
			Glide.with(this).load(headUrl).into(image);
			return;
		}
