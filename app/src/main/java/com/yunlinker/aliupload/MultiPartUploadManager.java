    ...
    public PauseableUploadTask asyncUpload(String objectName, String localFileName,final upLoadSuccessCallBack callBack) {
        ...
        final PauseableUploadTask task = new PauseableUploadTask(oss, request, new OSSCompletedCallback<PauseableUploadRequest, PauseableUploadResult>() {
            ...
            public void onSuccess(PauseableUploadRequest request, PauseableUploadResult result) {
                String url=result.getObjectKey()+"";
                //if(EventControl.getInstance().getUploadFileAliyunInterface()!=null){
                    //EventControl.getInstance().getUploadFileAliyunInterface().sendUrl(url);
                //}
            }
