...
public class EaseSidebar extends View {
	...
	private EaseContactList.SelecttionListView  se;
	public void setListView(ListView listView){
		mListView = listView;
	}
	public void setMySelection(EaseContactList.SelecttionListView selection){
		this.se=selection;
	}
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		...
		if(se!=null)
			se.selection(headerString);
		/*EaseMyMailListContactAdapterNew adapter =(EaseMyMailListContactAdapterNew) mListView.getAdapter();

		List<String> listLatter=adapter.myLatterList();
		if(listLatter.contains(headerString)){
