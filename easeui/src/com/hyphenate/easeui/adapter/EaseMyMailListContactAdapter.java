...
public class EaseMyMailListContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer {
    ...
    Context context;
    public EaseMyMailListContactAdapter(Context context, int resource, List<EaseUser> objects, List<GroupUserInfo> groupUserInfos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EaseUserUtils.MailListloadHeadImageView(context,userinfo.getHead(),holder.avatar);
        ...
        protected synchronized FilterResults performFiltering(CharSequence prefix) {
            ...
            if(prefix==null || prefix.length()==0){
                ...
                for(int i=0;i<count;i++){
                    ...
                    String username =  user.getInitialLetter();//user.getUsername();
    ...
    public EaseMyMailListContactAdapter setPrimaryColor(int primaryColor) {
        this.primaryColor = primaryColor;
        return this;
    }


    public EaseMyMailListContactAdapter setPrimarySize(int primarySize) {
        this.primarySize = primarySize;
        return this;
    }

    public EaseMyMailListContactAdapter setInitialLetterBg(Drawable initialLetterBg) {
        this.initialLetterBg = initialLetterBg;
        return this;
    }

    public EaseMyMailListContactAdapter setInitialLetterColor(int initialLetterColor) {
