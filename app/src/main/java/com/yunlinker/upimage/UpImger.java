...
public class UpImger {
    ...
    public void upimgs(JSONObject jb, WebviewActivity a) {
          this.ma = a;
        try {
        ...
        uploadEvent = new UploadEvent() {
            ...
            public void finished(ArrayList<String> list) {
                ...
                if(list.size()>0) {
                    ...
                    ma.setValue("upimg",finalUrls.substring(0,finalUrls.length()-1));
                ...
                Luban.get(ma).load(file)
                        ...
                        .launch(new OnCompressListener() {
                            ...
                            public void onSuccess(File file) {
                                ...
                                fileMap.put("name",str+"/a"+random+".jpg");
                                Log.e("upimage", "onSuccess: "+file.getName());
