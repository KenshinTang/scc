...
template.defaults.imports.getSymbol = function (consumeAct) {
    if (consumeAct == 2){
        return '+';
    } else {
        return '-';
...
template.defaults.imports.widthPer = function (score) {
    var widthPer = Number(score||0) / 5 * 100;
    return widthPer;
}

template.defaults.imports.fromType = function (getState) {
