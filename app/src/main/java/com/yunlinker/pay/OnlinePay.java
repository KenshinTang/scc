...
public class OnlinePay {
    ...
    public void startPay(JSONObject obj, final WebviewActivity a) {
    ...
    private void alipay(final String order, final WebviewActivity a) {
    ...
    private void wechatpay(final String order, WebviewActivity a) {
        if(pg!=null) {
            pg.dismiss();
            pg=null;
        }
